...
can be passed and types `stored in memory <types.html#data-location>`_ will be passed by reference and not copied.
...
The following example shows how to use `types stored in memory <types.html#data-location>`_ and
